...
<template>
  <!-- use keydown and up both, browsers show variation -->
  <div
    @click="appStore.closeForm"
  ...
  >
    <div @click.stop="" class="">
      ...
      >
        ...
        <div v-else-if="appStore.formRoute == 'passwordReset'">
          Reset Password
        </div>
        <div @click="appStore.closeForm" class="cursor-pointer" tabindex="0">
          <Icon
