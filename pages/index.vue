...
<template>
  ...
  <!-- seperator -->
  <div
    class="bg-gradient-to-b from-light-secondary to-light-background text-light-text px-2"
  >
    <div
  ...
  <!-- learn -->
  <h2
    class="bg-light-background text-light-text text-center text-4xl font-medium tracking-wide pt-8"
  >
    Our Offerings
  </h2>
    ...
    >
      ...
      <NuxtLink to="/courses">
        ...
        >
          <div>
            <Icon
              class="text-8xl p-2 rounded-full bg-light-secondary"
      ...
      <NuxtLink to="/counseling">
        ...
        >
          <div>
            <Icon
              class="text-8xl p-3 rounded-full bg-light-secondary"
  ...
  <div class="bg-light-background text-light-text">
    ...
    <div class="max-w-7xl mx-auto px-4 py-10">
      ...
      <p class="text-lg">
        ...
        students, emerging entrepreneurs or well-established business people, we
  ...
  <div class="bg-light-background text-light-text">
    <div class="max-w-7xl mx-auto px-4 py-10">
      ...
      <div class="flex flex-col md:flex-row items-center gap-8">
        <img
          class="w-[32rem] aspect-square border-8 rounded-3xl border-light-secondary"
          src="/img/staffs.jpg"
          alt="ceo"
        />
        <div>
      ...
      <div class="mt-8 flex flex-col md:flex-row justify-between">
        ...
        <div class="flex flex-col items-center gap-4">
          <img
            class="w-96 aspect-square border-8 rounded-3xl border-light-secondary"
            src="/img/staffs.jpg"
            alt="coo"
          />
          <div>
